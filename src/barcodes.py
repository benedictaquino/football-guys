...
for n, pos in zip(n_sets, positions):
    for week in range(1,18):
        ...
        observer_barcode_title = "{} Week {}: Barcode Diagram for $\\beta_0$ of the Observer Complex".format(pos,week)
        ...
        landmark_barcode_title="{} Week {}: Barcode Diagram for $\\beta_0$ of the Landmark Complex".format(pos,week)
